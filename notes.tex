...
\firstterm{values captured} from \verb|s| by \verb|p|, or the
\firstterm{capture values} of \verb|p| at \verb|s|.
...
\firstterm{pattern constructor} is a function that takes certain
...
\verb|Sub(p)| are called the \firstterm{subpatterns} of \verb|p|.
